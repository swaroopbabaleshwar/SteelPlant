...
const ProductsTable = (props) => {
  ...
  const editProducts = (pdtValues = {}) => {
    ...
    let data = {
        ...
        thinkness: pdtValues.Thickness,
        length: pdtValues.Length
    }
    RestAPI.editProducts({
        params: {
            ...data
        }
    }).then(resp => {
        ...
        return editable ? (
            <span>
                ...
                <div style={{ width: '2rem', display: 'flex' }}>
                    ...
                    <a onClick={() => deleteProduct(record)}> <DeleteOutlined style={{ fontSize: '18px', color: 'green', padding: '3px 1rem'}}/> </a>
                </div>
            )
      },
    },
